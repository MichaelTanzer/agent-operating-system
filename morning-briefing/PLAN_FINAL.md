...
Stagger is deliberate: 5-minute gaps prevent concurrent load and keep messages sequential in the Discord DM.
...
Deliverables:
- `watchlist_digest.py` with 23-company list loaded from `config/watchlist.yaml`
...
4. Confirm delivery in Discord DM
...
- Email delivery (Discord DM until MT's dedicated inbox is ready)
